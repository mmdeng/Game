...
namespace Tetris
{
	public class Draw
	{
		...
		//========================================================================================
		// Name		: MakeBackGround
		// Function	: 背景作成。最初に一回だけ作成しておき、dat.BMP_BACKに保持しておく。
		//
		...
		//----------------------------------------------------------------------------------------
		// dat			| Data				| i | Data
		// e			| PaintEventArgs	| i | OnPaintパラメータ
		//----------------------------------------------------------------------------------------
		// Return		| void				| o | Nothing
		//========================================================================================
	...
	// Playing
		...
		//========================================================================================
		// Name		: GetBmpRect
		// Function	: ブロックのBitmapﾌｧｲﾙの指定領域を返す
		//
		// Parameter	| Format			|i/o| Description
		//----------------------------------------------------------------------------------------
		// dat			| Data				| i | Data
		// nBlockType	| int				| i | ブロックタイプｲﾝﾃﾞｯｸｽ
		//----------------------------------------------------------------------------------------
